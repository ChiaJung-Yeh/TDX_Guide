...
TDX_table=data.frame(parameter=c("`app_id=`", "`app_key=`", "`operator=`", rep("`out=`", 2)),
                     ...
                     func=c("[金鑰 APP ID]","[金鑰 APP Key]","營運機構代碼", rep("匯出資料之路徑", 2)),
...
:::notice
<font size="4">**NOTE**</font>  
R 語言「依規則繪製地圖」之方法，請參考 [Spatial Analysis with R (Chia Jung, Yeh) 3.5 章節 Categorized Symbol Map](https://chiajung-yeh.github.io/Spatial-Analysis/data-visualization-with-maps.html#categorized-symbol-map)
:::
...
TDX_table=data.frame(parameter=c("`app_id=`", "`app_key=`", "`operator=`", rep("`record=`", 2), rep("`out=`", 2)),
                     ...
                     func=c("[金鑰 APP ID]", "[金鑰 APP Key]", "營運機構代碼", rep("班表記錄方式", 2), rep("匯出資料之路徑", 2)),
