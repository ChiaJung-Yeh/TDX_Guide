...
本套件更新於2022-03-12，套件版本為1.3，請確保 TDX 套件為最新版本！
:::
...
version_table=data.frame(version=c("1.0","1.1","1.2","1.2.1","1.2.2","1.3"),
                         date=c("2022-02-08","2022-02-10","2022-02-14","2022-02-28","2022-03-05","2022-03-12"),
                     update=c("公車、軌道、自行車之公共運輸介接函式", "新增地理編碼服務", "新增航空班表、觀光景點、道路路網介接函式", "修正地理編碼函式錯誤 (Unicode亂碼問題)", "修正地理編碼函式錯誤 (HTTP ERROR問題)","新增公車路線介接函式"))
