...
TDX_table=data.frame(data=c(rep("軌道", 4), rep("公車", 3), rep("自行車", 2), "航空", "觀光景點", "道路路網", "地理編碼"), type=c("軌道站點","軌道路線站點","軌道路線線型","軌道班表","公車站點","公車路線線型","公車班表","公共自行車站點","自行車路網","航空班表","觀光景點點位","道路路網線型","地理編碼服務"), class=c(rep("點", 2),"線","文字","點","線","文字","點","線","文字","點","線","點"), functiona=c("[`Rail_Shape()`](#軌道站點資料)","`Rail_Station()`","`Rail_StationOfLine()`","`Rail_TimeTable()`","`Bus_StopOfRoute()`","`Bus_Shape()`","`Bus_Schedule()`","`Bike_Station()`","`Bike_Shape()`","`
