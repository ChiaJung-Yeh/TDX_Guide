...
[社會經濟資料服務平臺](https://segis.moi.gov.tw/STAT/Web/Portal/STAT_PortalHome.aspx)提供各層級行政區（縣市/鄉鎮市區/村里）的社經資料，涵蓋人口、勞動就業、土地營建、教育文化、醫療衛生、產業等社會各面向之資料。惟因人口資料最為完整，故本套件中僅自該平臺介接人口與住宅普查資料。
...
請確保 TDX 套件為最新版本！<br>
R 套件更新於 2023-08-24，套件版本為 3.3<br>
Python 套件更新於 2023-05-10，套件版本為 0.1.42 (註：Python 套件仍在努力更新中...)
:::
...
執行以上程式碼後，於 RStudio 右下角介面 Help 對話窗自動跳出函式資訊。另外亦可點[此](https://rdrr.io/github/ChiaJung-Yeh/NYCU_TDX/)查詢本套件所有函式及其功能。
