...
TDX_bike=cbind(select(TDX_County, Operator, Code)[-23,], bike=c("YouBike 1.0、YouBike 2.0", "YouBike 1.0、YouBike 2.0", "YouBike 1.0", "YouBike 1.0、YouBike 2.0 （ibike）", "T-Bike", "YouBike 2.0", "--", "YouBike 1.0", "--", "YouBike 1.0", "-- （參見備註）", "--", "--", "--", "YouBike 2.0", "Pbike", "--", "--", "--", "K Bike", "--", "--"))
